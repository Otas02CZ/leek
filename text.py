...
initial_localization = {
    'cs' : {
        ...
        'copy_no_copy_in_select' : '[bold red]Nelze kopírovat do vyznačených[/bold red]',
        ...
        'item_copyrenamed' : '[bold green]Přejmenována položka - [/bold green][bold blue]{}[/bold blue][bold green] - na - [/bold green][bold blue]{}[/bold blue]',
